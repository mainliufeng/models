...
from utils import bert_checkpoint_converter_lib
...
def main(_):
  ...
  if FLAGS.create_v2_checkpoint:
    name_replacements = bert_checkpoint_converter_lib.BERT_V2_NAME_REPLACEMENTS
    permutations = bert_checkpoint_converter_lib.BERT_V2_PERMUTATIONS
  else:
    name_replacements = bert_checkpoint_converter_lib.BERT_NAME_REPLACEMENTS
    permutations = bert_checkpoint_converter_lib.BERT_PERMUTATIONS

  bert_checkpoint_converter_lib.convert(FLAGS.checkpoint_from_path,
