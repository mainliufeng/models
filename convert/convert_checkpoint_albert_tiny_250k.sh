...
python /home/liufeng/Code/github/models/convert/run_bert_tf1_to_keras_checkpoint_convert.py \
...
python /home/liufeng/Code/github/models/convert/run_bert_tf2_checkpoint_convert.py \
